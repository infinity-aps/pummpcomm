defmodule Pummpcomm.History.MealMarker do
  ...
  def decode(
        <<_::7, carb_high_bit::1, timestamp::binary-size(5), carb_low_bits::8, _::6, unit_bit::1,
          _::1>>,
        _
      ) do
  ...
  defp carbohydrates(carb_high_bit, carb_low_bits, :grams),
    do: (carb_high_bit <<< 8) + carb_low_bits
