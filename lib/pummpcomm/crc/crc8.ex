defmodule Pummpcomm.Crc.Crc8 do
  @moduledoc """
  8-bit [Cyclic Redundancy Check](https://en.wikipedia.org/wiki/Cyclic_redundancy_check).
  """
  ...
  # Formatted as 16x16 to easier checking for typos
  # TODO find source of table.  There are more than one CRC8 table
  @crc_table [ 0x0, 0x9B, 0xAD, 0x36, 0xC1, 0x5A, 0x6C, 0xF7, 0x19, 0x82, 0xB4, 0x2F, 0xD8, 0x43, 0x75, 0xEE,
  ...
  @doc """
  8-bit [Cyclic Redundancy Check](https://en.wikipedia.org/wiki/Cyclic_redundancy_check) of `binary`.
  """
