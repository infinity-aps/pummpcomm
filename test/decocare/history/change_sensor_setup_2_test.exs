defmodule Decocare.History.ChangeSensorSetup2Test do
  use ExUnit.Case
  ...
  test "Change Sensor Setup 2 - 1" do
    ...
    decoded_events = Decocare.History.decode_records(history_page, %{ supports_low_suspend: true })
  ...
  test "Change Sensor Setup 2 - 2" do
    ...
    decoded_events = Decocare.History.decode_records(history_page, %{ supports_low_suspend: false })
    assert {:change_sensor_setup_2, %{timestamp: ~N[2008-01-01 00:00:00], raw: ^history_page}} = Enum.at(decoded_events, 0)
  end
end
