defmodule Decocare.CgmTest do
  use ExUnit.Case

  doctest Decocare.Cgm
  ...
  test "decodes correct number of events", %{cgm_page: cgm_page} do
    assert {:ok, decoded_events} = Decocare.Cgm.decode(cgm_page)
  ...
  test "correctly identifies sensor data" do
    ...
    {:ok, decoded_events} = Decocare.Cgm.decode(cgm_page)
  ...
  test "full page decode works as expected" do
    ...
    assert cgm_page == reconstituted_cgm_page <> <<Decocare.Crc16.crc_16(reconstituted_cgm_page)::size(16)>>
  end
end
