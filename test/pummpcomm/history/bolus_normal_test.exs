defmodule Pummpcomm.History.BolusNormalTest do
  ...
  test "Bolus Normal - Smaller" do
    ...
    decoded_events =
      Pummpcomm.History.decode_records(history_page, %{large_format: false, strokes_per_unit: 10})
  ...
  test "Bolus Normal - Larger" do
    ...
    decoded_events =
      Pummpcomm.History.decode_records(history_page, %{large_format: true, strokes_per_unit: 40})
