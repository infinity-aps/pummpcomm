defmodule Pummpcomm.History.CalBGForPHTest do
  ...
  test "Cal BG For PH - 1" do
    ...
    assert {:cal_bg_for_ph,
            %{amount: 217, timestamp: ~N[2017-02-13 20:03:01], raw: ^history_page}} =
  ...
  test "Cal BG For PH - 2" do
    ...
    assert {:cal_bg_for_ph,
            %{amount: 107, timestamp: ~N[2017-02-14 01:02:43], raw: ^history_page}} =
             Enum.at(decoded_events, 0)
  end
  ...
  test "Cal BG For PH Middle Amount Bit" do
    ...
    assert {:cal_bg_for_ph,
            %{amount: 473, timestamp: ~N[2017-02-13 20:03:01], raw: ^history_page}} =
             Enum.at(decoded_events, 0)
  end
  ...
  test "Cal BG For PH High Amount Bit" do
    ...
    assert {:cal_bg_for_ph,
            %{amount: 729, timestamp: ~N[2017-02-13 20:03:01], raw: ^history_page}} =
             Enum.at(decoded_events, 0)
  end
end
