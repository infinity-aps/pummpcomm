defmodule Pummpcomm.History.ResultDailyTotalTest do
  ...
  test "Result Daily Total - Smaller" do
    ...
    assert {:result_daily_total,
            %{strokes: 1912, units: 47.8, timestamp: ~N[2017-02-14 00:00:00], raw: ^history_page}} =
  ...
  test "Result Daily Total - Larger" do
    ...
    assert {:result_daily_total,
            %{strokes: 0, units: 0.0, timestamp: ~N[2015-03-24 00:00:00], raw: ^history_page}} =
             Enum.at(decoded_events, 0)
  end
end
